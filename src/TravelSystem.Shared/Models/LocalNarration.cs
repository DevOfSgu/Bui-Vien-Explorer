...
namespace TravelSystem.Shared.Models
{
    public class LocalNarration
    {
        ...
        public string ContentHash { get; set; } = string.Empty; // Mã băm nội dung để nhận biết thay đổi
        public int DownloadStatus { get; set; } = 0; // 0: NotStarted, 1: Downloading, 2: Ready, 3: Error
